...
import ru.sfedu.postHibernate.models.singleTable.*;
...
import ru.sfedu.postHibernate.utils.HibernateUtilST;
...
public class DataProviderSingleTable implements IDataProviderHibernate {
    private static Logger log = LogManager.getLogger(DataProviderSingleTable.class);
    ...
    public Money getMoney(long id) {
        return HibernateUtilST.getSessionFactory().openSession().get(Money.class, id);

    }

    @Override
    public ValuablePack getValPack(long id) {
        return HibernateUtilST.getSessionFactory().openSession().get(ValuablePack.class, id);
    }

    @Override
    public Letter getLetter(long id) {
        return HibernateUtilST.getSessionFactory().openSession().get(Letter.class, id);
    }
    ...
    public List<?> getListOfCreatedTables() {
        ...
        try {
            ...
            Query query = session.getNamedNativeQuery(HSQLDB_CATALOG_SINGLETABLE);

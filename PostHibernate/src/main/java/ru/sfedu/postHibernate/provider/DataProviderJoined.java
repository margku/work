...
import ru.sfedu.postHibernate.utils.HibernateUtilJ;
...
public class DataProviderJoined implements IDataProviderHibernate {
    private static Logger log = LogManager.getLogger(DataProviderJoined.class);
    ...
    public Result addMoney(long sender, long recipient, String addressFrom, long postOfficeFrom, String addressTo, long postOfficeTo, int price, String date, int sum, String currency) {
        try {
            ...
            Session session = HibernateUtilJ.getSessionFactory().openSession();
    ...
    public Money getMoney(long id) {
        return HibernateUtilJ.getSessionFactory().openSession().get(Money.class, id);

    }

    @Override
    public ValuablePack getValPack(long id) {
        return HibernateUtilJ.getSessionFactory().openSession().get(ValuablePack.class, id);
    }

    @Override
    public Letter getLetter(long id) {
        return HibernateUtilJ.getSessionFactory().openSession().get(Letter.class, id);
    }
    ...
    public List<?> getListOfCreatedTables() {
        ...
        try {
            ...
            Query query = session.getNamedNativeQuery(HSQLDB_CATALOG_JOINED);
